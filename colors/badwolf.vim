...
call s:HL('MatchParen', 'blackgravel', 'toffee', 'bold')
...
call s:HL('Search',    'coal', 'mediumgravel', 'bold')

" copy hightlight
call s:HL('IncSearch', 'coal', 'deepgravel',    'bold')

call s:HL('Underlined', 'fg', '', 'underline')

" bar at bottom
call s:HL('StatusLine',   'coal', 'mediumgravel',     'bold')
...
call s:HL('SpecialComment', 'saltwatertaffy', 'bg', 'bold')
...
call s:HL('Identifier', 'tardis', '', 'none')
call s:HL('Function',   'tardis', '', 'none')

" Preprocessor stuff is lime, to make it pop.
" note: I changed it to dress
"
" This includes imports in any given language, because they should usually be
" grouped together at the beginning of a file.  If they're in the middle of some
" other code they should stand out, because something tricky is
" probably going on.
call s:HL('PreProc',   'dress', '', 'none')
call s:HL('Macro',     'dress', '', 'none')
call s:HL('Define',    'dress', '', 'none')
call s:HL('PreCondit', 'dress', '', 'bold')
